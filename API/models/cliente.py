...
class Cliente():
    ...
    def crear_cliente(data):
        ...
        cur = mysql.connection.cursor()
        cur.execute('INSERT INTO cliente (nombre, apellido, cuit_cuil, direccion, email, telefono, id_usuario) VALUES (%s, %s, %s, %s, %s, %s, %s)', (data["nombre"], data["apellido"], data["cuit_cuil"], data["direccion"], data["email"], data["telefono"], session['id']))
