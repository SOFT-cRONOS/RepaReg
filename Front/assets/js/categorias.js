...
const buscarCategoria = () => {
  ...
  console.log("Buscar el categoria...", textoBuscado);
};

const buscarCatagoria = () => {
...
btnBuscarCategoria.addEventListener("click", buscarCategoria);

btnEditarCategoria.addEventListener("click", buscarCatagoria);
